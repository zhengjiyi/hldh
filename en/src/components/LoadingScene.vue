    ...
    <!-- <div class="loading-progress-bar nostripes" v-if="progress<100 || !videoAutoPlayEnable">
      <span :style="`width: ${progress}%`"></span>
 		  ...
 		  <div class="cop">
	        ...
	        :src="`${publicPath}img/1.gif`"
	      /> 
	       <span   :class="['btn animated slideInUp', (progress < 100 || !videoAutoPlayEnable) && 'disable']" class="">START</span>
    </div>
    <!--<div
      :class="['btn animated slideInUp', (progress < 100 || !videoAutoPlayEnable) && 'disable']"
    >-->
     
      <!--<img v-if="axs" :class="['btn animated slideInUp', (progress < 100 || !videoAutoPlayEnable) && 'disable']" :src="`${publicPath}img/str.png`" class="str"/>-->
