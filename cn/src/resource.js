...
export const data = {
  cn: {
    ...
    scene1: {
      ...
      videos: ['https://www.hytera.com/html/video/CN1.mp4'],
    },
    scene2: {
      bgc: '#52668a',
      bg: 'cn-bg.png',
      ...
      videos: [
        'https://www.hytera.com/html/video/CN2B760.mp4',
        'https://www.hytera.com/html/video/CN2A680.mp4',
      ],
    ...
    scene3: {
      ...
      question: 'cn-question.png',
      posters: ['poster.png'],
      videos: ['https://www.hytera.com/html/video/CN3.mp4'],
    },
    scene4: {
      bgc: '#aabbd4',
      bg: 'bg.png',
      ...
      question: 'cn-question.png',
      posters: ['poster.png'],
      videos: ['https://www.hytera.com/html/video/CN4.mp4'],
    },
    scene5: {
      bgc: '#8797b3',
      bg: 'bg.png',
      ...
      question: 'cn-question.png',
      posters: ['poster.png'],
      videos: ['https://www.hytera.com/html/video/CN5.mp4'],
    },
    ...
    scene6: {
      ...
      question: 'cn-question.png',
      posters: ['poster.png'],
      videos: ['https://www.hytera.com/html/video/CN6.mp4'],
